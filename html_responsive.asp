...
@media screen and (max-width: 1300px) {
  ...
  <a id="signupbtn_topnav" class="w3-bar-item w3-button bar-item-hover w3-hide-small w3-padding-24 barex" href="/signup/index.html" title="Sign Up to Improve Your Learning Experience">Sign Up</a>
  <a id="spacesbtn_topnav" style="display:none" class="w3-bar-item w3-hide-small w3-button bar-item-hover w3-padding-24 barex" href="https://spaces.w3schools.com" title="Go to Your Space">Spaces</a>  
  ...
  <div class="w3-right w3-padding-16">
    ...
    <a class="w3-bar-item w3-button w3-right ws-hide-1066 w3-hide-small barex ws-yellow ws-hover-yellow gt-btn-top-spaces" style="width: 150px;border-radius: 25px; margin-right: 15px;" href="https://www.w3schools.com/spaces" target="_blank" title="Get Your Own Website With W3Schools Spaces">Create Website</a>
    ...
    <a class="w3-bar-item w3-button w3-right w3-hover-dark-grey ws-hide-900 w3-hide-small ws-hide-1160 barex topnavmain_pro gt-btn-top-pro" style="border-radius: 25px; margin-right: 15px;" href="/pro/index.php" target="_blank" title="Go Pro to Improve Your Learning Experience">Pro</a>    
...
<p>Another popular CSS framework is Bootstrap. Bootstrap uses HTML, CSS and jQuery to make responsive web pages.</p>
...
content=&quot;width=device-width, initial-scale=1&quot;&gt;<br>&lt;link rel=&quot;stylesheet&quot; 
href=&quot;https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css&quot;&gt;<br>
&lt;script 
src=&quot;https://ajax.googleapis.com/ajax/libs/jquery/3.6.1/jquery.min.js&quot;&gt;&lt;/script&gt;<br>
&lt;script 
src=&quot;https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js&quot;&gt;&lt;/script&gt;<br>
...
window.addEventListener("load", function(event) {
  var a = MyLearning._user_is_logged_in;
  if (a) {
